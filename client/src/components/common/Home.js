            ...
            <div>
              <div className='paragraph'>
                ...
                <div className='hero-buttons'>
                  ...
                  <Link to="/wines">
                    <Button variant='warning'><span>Shop All Wines</span></Button>{' '}
                  </Link>
                </div>
              </div>
            </div>
          ...
          <Row>
            <Col xs={12} md={8}>
              <div className='choice-wrapper'>
                <div className='wine'>
                  <h2>Red Or White
                    <br/>We have all you want
                  </h2>
                </div>
                <div className='covered'>
                  <p>This is Wine Down
                    <br/>We are your personal marketplace to add to your cellars</p>
                </div>
              </div>
