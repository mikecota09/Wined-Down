...
const suggestedwineSchema = new mongoose.Schema({
...
// Ratings 
suggestedwineSchema.virtual('avgRating')
  .get(function() { 
    //get all the ratings
...
suggestedwineSchema.set('toJSON', {
  virtuals: true
})
...
// define model
export default mongoose.model('Suggestedwine', suggestedwineSchema)
